...
const data = {
    ...
    Home: {
        introduction: "I am a Full Stack Developer, and I prefer using Next.js, Typescript, Tailwind CSS to build business websites.",
        resumeLink: "afaff452",
        typedElement: ["@seniorcoder72", "Full Stack Developer", "Frontend/Backend Development", "MERN Stack / Typescript + Next.js + TailwindCSS", "PayPal/Stripe/... Payment Gateway Integration", "Email Verification/Automation", "AWS/Hosting", "DevOps"]
    },
    About: {
        ...identity,
        NavTabs: [{
        ...
        about: {
            "tech-stats": "Full Stack Web Developer, Python Backend Django Development, C#/.Net/Java/C++ Destop App Development, Data Science And DevOps Enthusiast",
            bio: "In my previous role as a full-stack developer at TrademarkToday, I had the opportunity to develop the entire website using cutting-edge technologies such as Next.js, TypeScript, and Tailwind CSS. I successfully implemented features like live chat and integration of payment systems with Stripe, enhancing the overall functionality and user experience of the site. Additionally, I leveraged REST APIs to seamlessly collaborate with external platforms, ensuring smooth data exchange and integration between systems. The website also featured essential functionalities like email verification and integration, which I implemented effectively to streamline communication and enhance user engagement. During my time at TrademarkToday, I gained comprehensive experience in developing websites and utilizing various tools and frameworks. I am proficient in front-end and back-end development, database management, and version control systems. My expertise in web development allows me to tackle complex problems and deliver high-quality solutions efficiently. Beyond technical skills, I possess strong analytical abilities, attention to detail, and excellent problem-solving capabilities. I thrive in collaborative environments and have a demonstrated ability to work effectively with cross-functional teams, stakeholders, and clients.  ",
            "IDE, Editors & Tools": ["VS Code", "PyCharm", "Postman", "MongoDB", "Navicat", "Anaconda Navigator", "Atom", "Python 3.9", "BlueJ", "CodeBlocks", "Docker", "Vagrant", "SonarQube", "Swagger-UI"]
        },
        skills: [
            [{
                skill: "Javascript",
                ...
                skill: "MEAN/MERN Stack Development",
                progress: "85"
            }],
            [{
                skill: "Typescript",
        ...
        education: [{
            ...
            textAlignment: "right",
            degree: "Bachelor of Engineering with Honours in Computer Science ",
            college: "ICT Cluster, Singapore Institute of Technology",
            duration: "2009 - 2011",
            percentage: "CGPA:9.1"
        },{
    ...
    Portfolio: [{
        ...
        delay: "0.5s",
        project: "trademarktoday-nextjs",
        description: "Trademarktoday is trademark registering website in Australia -  Next.js + Typescript + Tailwind CSS, Google OAuth, Email Verification/Automation, Stripe/PayPal Payment Gateway Integration, AWS/Vercel Hosted.",
        placement: "top"
    }, {
        animationClass: "slideInUp",
        delay: "0",
        project: "invest-farm",
        description: "Invest Farm is a website that serves the purpose of facilitating investment in California's farming industry and helps create successful business stories.",
        placement: "top"
    }, {
        animationClass: "rotateInDownRight",
        delay: "0.5s",
        project: "Business-Dashboard",
        description: "This site is ecommerce site like zbooni, Mern Stack | Typescript | Tailwind CSS",
        placement: "top"
    }, {
        animationClass: "rotateInUpLeft",
        delay: "0.5s",
        project: "Google-Map-API",
        description: "Use google map api to get the best path from origin to destination through several midpoints.",
        placement: "bottom"
    }, {
        animationClass: "slideInDown",
        delay: "0",
        project: "Kanban-React",
        description: "React bootstrap website design",
        placement: "bottom"
    }, {
        animationClass: "rotateInUpRight",
        delay: "0.5s",
        project: "dynamic-post-nextjs",
        description: "Create post dynamically like twitter",
        placement: "bottom"
    }],
    Training: {
    ...
    Contact: [
        ...
        // },
        {
            ...
            links: [{
                // type: "tel:",
                title: "https://join.skype.com/invite/uyW9RHm1JWqR"
            }]
        }, {
            animationClass: "Up",
            title: "Discord",
            ...
            links: [{
                // type: "tel:",
                title: "https://discordapp.com/users/1105307578721906688"
            }]
        }, {
            animationClass: "Down",
            title: "Telegram",
            ...
            links: [{
                // type: "tel:",
                title: "https://t.me/wonderfullcoder"
            }]
        }, {
            animationClass: "Right",
            title: "GMail",
            ...
            links: [{
                type: "mailto:",
                title: "milkyway464203@gmail.com"
            }]
        }],
    Social: [
        [{
            link: "https://github.com/seniorcoder72",
            class: "fa fa-github",
            name: "GitHub",
            placement: "left"
        }, {
            link: "mailto:milkyway464203@gmail.com",
            class: "fa fa-google",
            name: "GMail",
            placement: "top"
        }, {
            link: "https://join.skype.com/invite/uyW9RHm1JWqR",
            class: "fa fa-skype",
            name: "Skype",
            placement: "bottom"
        }, {
            link: "https://discordapp.com/users/1105307578721906688",
            class: "fa fa-phone",
            name: "Discord",
            placement: "top"
        }, {
            link: "https://t.me/wonderfullcoder",
    ...
    Footer: {
        dev: {
            name: "dev",
            link: "https://dev.to/seniorcoder72",
            image: "monkey"
        },
        citation: {
            ...identity,
